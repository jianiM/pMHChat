...
class ProteinGraphDataset(InMemoryDataset):
    ...
    def process(self,sample_list,ratio,peptide_info_dict_dir,mhc_info_dict_dir):
        ...
        for i in range(data_len):
            ...
            # GCNData.af = torch.FloatTensor(af)  
...
if __name__ == "__main__": 
    ...
    fold_root_path = config.fold_root_path_topofallfeature        # "/home_exp_2/jiani.ma/mhc/BD2016/5fold/"
    ...
    for i in range(kfold):
        ...
        fold_path = os.path.join(fold_root_path,'fold'+str(i+1))            # "/home_exp_2/jiani.ma/mhc/BD2016/5fold/fold1"
